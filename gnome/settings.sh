...
gsettings set org.gnome.desktop.wm.keybindings raise-or-lower "['<Control>Tab']"
...
dconf write /org/gnome/shell/extensions/dash-to-panel/panel-size 27
dconf write /org/gnome/shell/extensions/dash-to-panel/appicon-padding 0
